...
export default function LoginScreen({ navigation }) {
    ...
    return (
        <View style={{ alignItems: 'center', justifyContent: 'center' }}>
            ...
            <Pressable backgroundColor={'#5F59F7'} style={{ top: windowHeight * 0.28, height: 60, width: 320, borderRadius: 40, alignItems: 'center', justifyContent: 'center' }} onPress={handleLogInClick}>
